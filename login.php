...
//
    ...
    if (mysqli_num_rows($check)>=1)
    {
       echo "Username already taken";
        ...
        {
      $pass_md5=md5($pass);
		$insert = "INSERT INTO members (name,user,password,email,phone,state)
VALUES ('$name','$uname','$pass_md5','$email','$mobile','$state')";
                ...
                <div class="form-row">
                 ...
                 <div class="form-row">
                  ...
                  <div class="form-row">
                   ...
                   <div class="form-row">
             <select name="state" value="State"onchange="changeContent(this.value)">
                 ...
                 <div class="form-row">
					...
					<div class="form-row">
						<input type="checkbox" name="terms" value="yes" />I am agree to 
							accept our<a href="terms.php">Terms & Conditions </a>
							</div>
