...
<?php
	...
	$result = mysqli_query($con,"SELECT * FROM sell WHERE user ='$user' LIMIT $start,$limit");
...
<a href='edit_ads.php?u=$iid'><div class='madsimg'>
            <img src='$iimg'>
