							...
							<div class="grid_4">
							   ...
							   <form class="form-mini" method="post"  enctype="multipart/form-data" action="sell.php">
									`<div id="imagePreview"></div>
										...
										<div style="color:red" class="form-row">
											<input  type="text" name="title" placeholder=" * Title">
										</div>
										 <div class="form-row">
											<input type="text" name="prize" placeholder="* Price">
										 </div>
										<div class="form-row">
											<textarea style="resize:none;"type="text" cols="41" rows="6"name="desc" placeholder="* Description"></textarea>
										</div>
										 <div class="form-row">
																						...
																						if(imagecopyresampled($new_canvas, $image_resource , 0, 0, 0, 0, $new_image_width, $new_image_height, $img_width, $img_height))
																							{
																								...
																								//center watermark
																									$watermark_left = ($new_image_width/35)-(240/30); //watermark left
																									$watermark_bottom = ($new_image_height/40)-(169/40); //watermark bottom

																									$watermark = imagecreatefrompng($watermark_png_file); //watermark image
																									imagecopy($new_canvas, $watermark, $watermark_left, $watermark_bottom, 0, 0, 240, 169); //merge image
																								   ...
																								   $image_name=$title;
																									imagejpeg($new_canvas, $destination_folder.'/'.$image_name , 60);
																									...
																									//$state=$rows['state'];
																									$phone=$rows['phone'];
																									$insert = "INSERT INTO sell (id,ads_id,user,item_pix,title,description,prize,name,phone,category,sub_category,state)
																										VALUES ('$id','$ads_id','$user','$photo','$title','$desc','$prize','$name','$phone','$cat','$subcat','$state')";
